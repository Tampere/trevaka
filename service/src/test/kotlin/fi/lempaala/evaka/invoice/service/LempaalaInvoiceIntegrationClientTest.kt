...
import fi.lempaala.evaka.BucketProperties
import fi.lempaala.evaka.InvoiceProperties
...
class LempaalaInvoiceIntegrationClientTest {
    ...
    fun `valid invoice with invoice number`() {
        ...
        assertEquals(
            """310382-956DL  Meikäläinen Matti                                                                                   Meikäläisenkuja 6 B 7         90100 OULU                                                                                                                              1   K202102042021030620220505                    1                            1000         54   Varhaiskasvatus 01.2021                                                                                                                                                                                                                                                                                      
