...
package fi.nokiankaupunki.evaka.pdfgen
...
class NokiaPdfGeneratorTest : AbstractNokiaIntegrationTest() {
    ...
    fun createDecisionPdf(decisionType: DecisionType, providerType: ProviderType, isTransferApplication: Boolean) {
        ...
        val filename = "nokia-decision-$decisionType-$providerType${if (isTransferApplication) "-transfer" else ""}.pdf"
    ...
    fun daycareAssistanceDecisionGeneratePdf() {
        ...
        val filename = "nokia-daycare-assistance-decision.pdf"
        writeReportsFile(filename, bytes)
    }
    ...
    fun preschoolAssistanceDecisionGeneratePdf() {
        ...
        val filename = "nokia-preschool-assistance-decision.pdf"
        writeReportsFile(filename, bytes)
    }
}
