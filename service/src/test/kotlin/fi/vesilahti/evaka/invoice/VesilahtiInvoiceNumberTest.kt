...
package fi.vesilahti.evaka.invoice
...
class VesilahtiInvoiceNumberTest : AbstractVesilahtiIntegrationTest() {
    @Autowired
        ...
        val invoices = db.transaction { tx ->
            ...
            val draftInvoice1 = tx.insert(
                DevInvoice(
                    ...
                    areaId = AreaId(UUID.fromString("d297bf95-dea7-4e9a-8ecb-5d6c9a85b850")),
                ),
            )
