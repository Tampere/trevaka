...
private val restrictedStreetAddress = "Varhaiskasvatus, Rautialantie 60"
private val restrictedPostCode = "37470"
private val restrictedPostOffice = "Vesilahti"

internal class ProEInvoiceGeneratorTest : AbstractVesilahtiIntegrationTest() {
    @Autowired
    private lateinit var proEInvoiceGenerator: ProEInvoiceGenerator
    ...
    fun `should return successfully created invoices in success list`() {
        ...
        val generationResult = proEInvoiceGenerator.generateInvoice(invoiceList, YearMonth.of(2024, 11))
