...
class VesilahtiInvoiceIntegrationClientTest : AbstractVesilahtiIntegrationTest() {
    @Autowired
    ...
    fun `valid invoice with invoice number`() {
        ...
        val data = getS3Object(properties.bucket.export, "invoices/Vesilahti_eVaka_01022021_123400.dat")
