...
package fi.vesilahti.evaka.pdfgen
...
class VesilahtiPdfGeneratorTest : AbstractVesilahtiIntegrationTest() {
    ...
    private fun createDecisionPdfValues() = ArgumentSets
        .argumentsForFirstParameter(supportedDecisionTypes())
    ...
    fun createDecisionPdf(decisionType: DecisionType, providerType: ProviderType, isTransferApplication: Boolean) {
        ...
        val filename = "vesilahti-decision-$decisionType-$providerType${if (isTransferApplication) "-transfer" else ""}.pdf"
