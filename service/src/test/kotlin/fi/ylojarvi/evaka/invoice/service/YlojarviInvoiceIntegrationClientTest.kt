...
import fi.ylojarvi.evaka.util.FinanceDateProvider
...
class YlojarviInvoiceIntegrationClientTest {

    private lateinit var ylojarviInvoiceIntegrationClient: YlojarviInvoiceIntegrationClient
    ...
    fun setup() {
        ...
        ylojarviInvoiceIntegrationClient = YlojarviInvoiceIntegrationClient(
            s3SenderMock,
    ...
    fun `valid invoice with invoice number`() {
        ...
        ylojarviInvoiceIntegrationClient.send(invoices)
...
310382-956D1Esiopetusta täydentävä varhaiskasvatus   000004820000kpl 00000001000000                                                            0                                                            3257300100026270484                                                    
310382-956D3Meikäläinen Matti                                                                                                                                                                  
310382-956D301.01.2021 - 31.01.2021                                                                                                                                                            
310382-956D1Varhaiskasvatus                          000002430000kpl 00000001000000                                                            0                                                            3257300100026270485                                                    
310382-956D301.01.2021 - 31.01.2021                                                                                                                                                            
310382-956D1Varhaiskasvatus                          000002500000kpl 00000001000000                                                            0                                                            3257300100026270483                                                    
""",
