...
package fi.ylojarvi.evaka.pdfgen
...
class YlojarviPdfGeneratorTest : AbstractYlojarviIntegrationTest() {
    ...
    fun createDecisionPdf(decisionType: DecisionType, providerType: ProviderType, isTransferApplication: Boolean) {
        ...
        val filename = "ylojarvi-decision-$decisionType-$providerType${if (isTransferApplication) "-transfer" else ""}.pdf"
    ...
    fun daycareAssistanceDecisionGeneratePdf() {
        ...
        val filename = "ylojarvi-daycare-assistance-decision.pdf"
        writeReportsFile(filename, bytes)
    }
    ...
    fun preschoolAssistanceDecisionGeneratePdf() {
        ...
        val filename = "ylojarvi-preschool-assistance-decision.pdf"
        writeReportsFile(filename, bytes)
    }
}
