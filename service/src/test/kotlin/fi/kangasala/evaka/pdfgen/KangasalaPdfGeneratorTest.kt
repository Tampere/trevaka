...
package fi.kangasala.evaka.pdfgen
...
class KangasalaPdfGeneratorTest : AbstractKangasalaIntegrationTest() {
    ...
    fun generateFeeDecisionPdf(placementType: PlacementType) {
        ...
        val filename = "kangasala-fee-decision-with-placement-type-$placementType.pdf"
        writeReportsFile(filename, bytes)
    }
    ...
    fun generateFeeDecisionPdf(decisionType: FeeDecisionType) {
        ...
        val filename = "kangasala-fee-decision-with-decision-type-$decisionType.pdf"
        writeReportsFile(filename, bytes)
    }
