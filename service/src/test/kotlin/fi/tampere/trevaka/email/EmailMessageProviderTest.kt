    ...
    fun contents(): Stream<Arguments> = listOf(
        ...
        Arguments.of(
            ...
            emailMessageProvider.calendarEventNotification(
                Language.fi,
                listOf(
                    CalendarEventNotificationData(HtmlSafe("Tapahtuma 1"), FiniteDateRange(LocalDate.of(2023, 8, 21), LocalDate.of(2023, 8, 21)), listOf(HtmlSafe("Ryhmä A"))),
                    CalendarEventNotificationData(HtmlSafe("Tapahtuma 2"), FiniteDateRange(LocalDate.of(2023, 8, 22), LocalDate.of(2023, 8, 23)), listOf(HtmlSafe("Ryhmä B"), HtmlSafe("Ryhmä C"))),
                ),
            ),
        ),
        Arguments.of(
