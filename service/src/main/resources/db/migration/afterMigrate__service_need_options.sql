...
INSERT INTO service_need_option
    (id, name_fi, name_sv, name_en, valid_placement_type, default_option, fee_coefficient, occupancy_coefficient, occupancy_coefficient_under_3y, daycare_hours_per_week, contract_days_per_month, part_day, part_week, fee_description_fi, fee_description_sv, voucher_value_description_fi, voucher_value_description_sv, active, show_for_citizen, display_order)
VALUES
    ('50358394-b961-11eb-b51f-67ac436e5636', 'Kokopäiväinen', 'Kokopäiväinen', 'Full-time', 'DAYCARE', TRUE, 1.0, 1.0, 1.75, 40, NULL, FALSE, FALSE, 'Kokopäiväinen', 'Kokopäiväinen', 'Kokopäiväinen', 'Kokopäiväinen', TRUE, TRUE, null),
    ('86ef70a0-bf85-11eb-91e6-1fb57a101161', 'Kokopäiväinen', 'Kokopäiväinen', 'Full-time', 'DAYCARE', FALSE, 1.0, 1.0, 1.75, 40, NULL, FALSE, FALSE, 'Kokopäiväinen', 'Kokopäiväinen', 'Kokopäiväinen', 'Kokopäiväinen', TRUE, TRUE, 0),
    ('503590f0-b961-11eb-b520-53740af3f7ee', 'Kokopäiväinen, 10 pv sopimus', 'Kokopäiväinen, 10 pv sopimus', 'Full-time, 10 day agreement', 'DAYCARE', FALSE, 0.5, 0.5, 0.88, 20, 10, FALSE, TRUE, 'Kokopäiväinen, 10 pv sopimus', 'Kokopäiväinen, 10 pv sopimus', 'Kokopäiväinen, 10 pv sopimus', 'Kokopäiväinen, 10 pv sopimus', TRUE, TRUE, 1),
    ('503591ae-b961-11eb-b521-1fca99358eef', 'Kokopäiväinen, 15 pv sopimus', 'Kokopäiväinen, 15 pv sopimus', 'Full-time, 15 day agreement', 'DAYCARE', FALSE, 0.75, 1.0, 1.75, 30, 15, FALSE, TRUE, 'Kokopäiväinen, 15 pv sopimus', 'Kokopäiväinen, 15 pv sopimus', 'Kokopäiväinen, 15 pv sopimus', 'Kokopäiväinen, 15 pv sopimus', TRUE, TRUE, 2),
    ('50359212-b961-11eb-b522-074fb05f7086', 'Osapäiväinen, max 5h päivässä', 'Osapäiväinen, max 5h päivässä', 'Part-time, max 5h per day', 'DAYCARE_PART_TIME', TRUE, 0.6, 0.5, 1.75, 25, NULL, TRUE, FALSE, 'Osapäiväinen, max 5h päivässä', 'Osapäiväinen, max 5h päivässä', 'Osapäiväinen, max 5h päivässä', 'Osapäiväinen, max 5h päivässä', TRUE, TRUE, null),
    ('86ef7370-bf85-11eb-91e7-6fcd728c518d', 'Osapäiväinen, max 5h päivässä', 'Osapäiväinen, max 5h päivässä', 'Part-time, max 5h per day', 'DAYCARE_PART_TIME', FALSE, 0.6, 0.5, 1.75, 25, NULL, TRUE, FALSE, 'Osapäiväinen, max 5h päivässä', 'Osapäiväinen, max 5h päivässä', 'Osapäiväinen, max 5h päivässä', 'Osapäiväinen, max 5h päivässä', TRUE, TRUE, 1001),
    ...
    ('50359334-b961-11eb-b525-f3febdfea5d3', 'Osapäiväinen, max 20h viikossa', 'Osapäiväinen, max 20h viikossa', 'Part-time, max 20h per week', 'DAYCARE_PART_TIME', FALSE, 0.5, 0.5, 0.88, 20, NULL, TRUE, FALSE, 'Osapäiväinen, max 20h viikossa', 'Osapäiväinen, max 20h viikossa', 'Osapäiväinen, max 20h viikossa', 'Osapäiväinen, max 20h viikossa', TRUE, TRUE, 1000),
    ('5035938e-b961-11eb-b526-6b30323c87a8', 'Tilapäinen varhaiskasvatus', 'Tilapäinen varhaiskasvatus', 'Temporary daycare', 'TEMPORARY_DAYCARE', TRUE, 1.0, 1.0, 1.75, 40, NULL, FALSE, FALSE, 'Tilapäinen varhaiskasvatus', 'Tilapäinen varhaiskasvatus', 'Tilapäinen varhaiskasvatus', 'Tilapäinen varhaiskasvatus', TRUE, TRUE, null),
    ...
    ('0a58d934-6fd1-11ed-a75e-c353faef5857', 'Täydentävä varhaiskasvatus, max 5h päivässä', 'Täydentävä varhaiskasvatus, max 5h päivässä', 'Preschool daycare - max 5 h per day', 'PRESCHOOL_DAYCARE', FALSE, 0.6, 0.5, 0.5, 25, NULL, TRUE, FALSE, 'Täydentävä varhaiskasvatus, max 5h päivässä', 'Täydentävä varhaiskasvatus, max 5h päivässä', 'Täydentävä varhaiskasvatus, max 5h päivässä', 'Täydentävä varhaiskasvatus, max 5h päivässä', TRUE, TRUE, 2000),
    ('0a58db0a-6fd1-11ed-a75e-bbde95c1adef', 'Täydentävä varhaiskasvatus, max 5h päivässä; 10 pv sopimus', 'Täydentävä varhaiskasvatus, max 5h päivässä; 10 pv sopimus', 'Preschool daycare – max 5 h per day; 10 day agreement', 'PRESCHOOL_DAYCARE', FALSE, 0.3, 0.25, 0.25, 12, 10, TRUE, TRUE, 'Täydentävä varhaiskasvatus, max 5h päivässä; 10 pv sopimus', 'Täydentävä varhaiskasvatus, max 5h päivässä; 10 pv sopimus', 'Täydentävä varhaiskasvatus, max 5h päivässä; 10 pv sopimus', 'Täydentävä varhaiskasvatus, max 5h päivässä; 10 pv sopimus', TRUE, TRUE, 2100),
    ('0a58dbe6-6fd1-11ed-a75e-5335f2b9a91b', 'Täydentävä varhaiskasvatus, max 5h päivässä; 15 pv sopimus', 'Täydentävä varhaiskasvatus, max 5h päivässä; 15 pv sopimus', 'Preschool daycare – max 5 h per day; 15 day agreement', 'PRESCHOOL_DAYCARE', FALSE, 0.45, 0.5, 0.5, 18, 15, TRUE, TRUE, 'Täydentävä varhaiskasvatus, max 5h päivässä; 15 pv sopimus', 'Täydentävä varhaiskasvatus, max 5h päivässä; 15 pv sopimus', 'Täydentävä varhaiskasvatus, max 5h päivässä; 15 pv sopimus', 'Täydentävä varhaiskasvatus, max 5h päivässä; 15 pv sopimus', TRUE, TRUE, 2200),
    ('0a58da38-6fd1-11ed-a75e-9b2790b0b4f5', 'Täydentävä varhaiskasvatus, yli 5h päivässä', 'Täydentävä varhaiskasvatus, yli 5h päivässä', 'Preschool daycare – over 5 h per day', 'PRESCHOOL_DAYCARE', FALSE, 0.8, 0.5, 0.5, 32, NULL, FALSE, FALSE, 'Täydentävä varhaiskasvatus, yli 5h päivässä', 'Täydentävä varhaiskasvatus, yli 5h päivässä', 'Täydentävä varhaiskasvatus, yli 5h päivässä', 'Täydentävä varhaiskasvatus, yli 5h päivässä', TRUE, TRUE, 2300),
    ('0a58dcae-6fd1-11ed-a75e-b3e10433b948', 'Täydentävä varhaiskasvatus, yli 5h päivässä; 10 pv sopimus', 'Täydentävä varhaiskasvatus, yli 5h päivässä; 10 pv sopimus', 'Preschool daycare – over 5 h per day; 10 day agreement', 'PRESCHOOL_DAYCARE', FALSE, 0.4, 0.25, 0.25, 18, 10, FALSE, TRUE, 'Täydentävä varhaiskasvatus, yli 5h päivässä; 10 pv sopimus', 'Täydentävä varhaiskasvatus, yli 5h päivässä; 10 pv sopimus', 'Täydentävä varhaiskasvatus, yli 5h päivässä; 10 pv sopimus', 'Täydentävä varhaiskasvatus, yli 5h päivässä; 10 pv sopimus', TRUE, TRUE, 2400),
    ...
    ('88f3bf1e-6646-11ed-8202-8f213a9146c2', 'Esiopetuksen kerho 1-3h päivässä', 'Esiopetuksen kerho 1-3h päivässä', 'Preschool club - 1-3 h per day', 'PRESCHOOL_CLUB', TRUE, 0.6, 0.5, 0.5, 25, NULL, TRUE, FALSE, 'Esiopetuksen kerho 1-3h päivässä', 'Esiopetuksen kerho 1-3h päivässä', 'Esiopetuksen kerho 1-3h päivässä', 'Esiopetuksen kerho 1-3h päivässä', TRUE, TRUE, null),
    ('88f3dfd0-6646-11ed-8202-4fe90b8e5485', 'Esiopetuksen kerho 1-3h päivässä', 'Esiopetuksen kerho 1-3h päivässä', 'Preschool club - 1-3 h per day', 'PRESCHOOL_CLUB', FALSE, 0.6, 0.5, 0.5, 25, NULL, TRUE, FALSE, 'Esiopetuksen kerho 1-3h päivässä', 'Esiopetuksen kerho 1-3h päivässä', 'Esiopetuksen kerho 1-3h päivässä', 'Esiopetuksen kerho 1-3h päivässä', TRUE, TRUE, 3000),
    ('88f3e214-6646-11ed-8202-f77aa4749644', 'Esiopetuksen kerho 3-5h päivässä', 'Esiopetuksen kerho 3-5h päivässä', 'Preschool club – 3-5 h per day', 'PRESCHOOL_CLUB', FALSE, 0.8, 0.5, 0.5, 32, NULL, FALSE, FALSE, 'Esiopetuksen kerho 3-5h päivässä', 'Esiopetuksen kerho 3-5h päivässä', 'Esiopetuksen kerho 3-5h päivässä', 'Esiopetuksen kerho 3-5h päivässä', TRUE, TRUE, 3100),
    ('88f3e3e0-6646-11ed-8202-3bc1b45aaa73', 'Esiopetuksen kerho yli 5h päivässä', 'Esiopetuksen kerho yli 5h päivässä', 'Preschool club – over 5 h per day', 'PRESCHOOL_CLUB', FALSE, 0.3, 0.25, 0.25, 12, 10, TRUE, TRUE, 'Esiopetuksen kerho yli 5h päivässä', 'Esiopetuksen kerho yli 5h päivässä', 'Esiopetuksen kerho yli 5h päivässä', 'Esiopetuksen kerho yli 5h päivässä', TRUE, TRUE, 3200),
    ('88f3e5a2-6646-11ed-8202-0b8db1a29ca5', 'Esiopetuksen kerho 1-3h päivässä; 10 pv sopimus', 'Esiopetuksen kerho 1-3h päivässä; 10 pv sopimus', 'Preschool club – 1-3 h per day; 10 day agreement', 'PRESCHOOL_CLUB', FALSE, 0.45, 0.5, 0.5, 18, 15, TRUE, TRUE, 'Esiopetuksen kerho 1-3h päivässä; 10 pv sopimus', 'Esiopetuksen kerho 1-3h päivässä; 10 pv sopimus', 'Esiopetuksen kerho 1-3h päivässä; 10 pv sopimus', 'Esiopetuksen kerho 1-3h päivässä; 10 pv sopimus', TRUE, TRUE, 3300),
    ('88f3e75a-6646-11ed-8202-b7867ae6358a', 'Esiopetuksen kerho 3-5h päivässä; 10pv sopimus', 'Esiopetuksen kerho 3-5h päivässä; 10pv sopimus', 'Preschool club – 3-5 h per day; 10 day agreement', 'PRESCHOOL_CLUB', FALSE, 0.4, 0.25, 0.25, 18, 10, FALSE, TRUE, 'Esiopetuksen kerho 3-5h päivässä; 10pv sopimus', 'Esiopetuksen kerho 3-5h päivässä; 10pv sopimus', 'Esiopetuksen kerho 3-5h päivässä; 10pv sopimus', 'Esiopetuksen kerho 3-5h päivässä; 10pv sopimus', TRUE, TRUE, 3400),
    ('88f3e912-6646-11ed-8202-bb9fe8059b4a', 'Esiopetuksen kerho yli 5h päivässä; 10pv sopimus', 'Esiopetuksen kerho yli 5h päivässä; 10pv sopimus', 'Preschool club – over 5 h per day; 10 day agreement', 'PRESCHOOL_CLUB', FALSE, 0.6, 0.5, 0.5, 24, 15, FALSE, TRUE, 'Esiopetuksen kerho yli 5h päivässä; 10pv sopimus', 'Esiopetuksen kerho yli 5h päivässä; 10pv sopimus', 'Esiopetuksen kerho yli 5h päivässä; 10pv sopimus', 'Esiopetuksen kerho yli 5h päivässä; 10pv sopimus', TRUE, TRUE, 3500),
    ('ff6ddcd4-fa8a-11eb-8592-2f2b4e398fcb', 'Kerho', 'Kerho', 'Club', 'CLUB', TRUE, 0.0, 1.0, 1.0, 0, NULL, TRUE, TRUE, 'Kerho', 'Kerho', 'Kerho', 'Kerho', TRUE, TRUE, null),
    ('d8681652-246b-11ed-b02b-ebe37c3347e8', 'Esiopetus', 'Esiopetus', 'Preschool', 'PRESCHOOL', TRUE, 0.0, 1.0, 1.0, 0, NULL, TRUE, TRUE, 'Esiopetus', 'Esiopetus', 'Esiopetus', 'Esiopetus', TRUE, TRUE, null),
    ('1b4413f6-d99d-11eb-89ac-a3a978104bce', 'Koululaisen vuorohoito', 'Koululaisen vuorohoito', 'School shift care', 'SCHOOL_SHIFT_CARE', TRUE, 1.0, 1.0, 1.0, 40, NULL, TRUE, FALSE, 'Koululaisen vuorohoito', 'Koululaisen vuorohoito', 'Koululaisen vuorohoito', 'Koululaisen vuorohoito', TRUE, TRUE, null)
ON CONFLICT (id) DO
UPDATE SET
