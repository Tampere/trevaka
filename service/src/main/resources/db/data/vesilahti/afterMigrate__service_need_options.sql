...
VALUES
    ...
    ('b0edf1ff-7b36-43b2-9577-e284d6bbc964', 'Valmistavan opetuksen liittyvä varhaiskasvatus', 'Valmistavan opetuksen liittyvä varhaiskasvatus', 'Preparatory education', 'PREPARATORY_DAYCARE_ONLY', TRUE, 0.0, 0.5, 0.5, 0.5, 0.5, 0, NULL, NULL, TRUE, TRUE, 'Valmistavan opetuksen liittyvä varhaiskasvatus', 'Valmistavan opetuksen liittyvä varhaiskasvatus', 'Valmistavan opetuksen liittyvä varhaiskasvatus', 'Valmistavan opetuksen liittyvä varhaiskasvatus', TRUE, TRUE, NULL),
