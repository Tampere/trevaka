...
VALUES
    ...
    ('36c8c2ed-7543-47de-bc42-14d163a6277d', 'Palveluseteli Varhaiskasvatus 85 tuntia / kuukausi', 'Palveluseteli Varhaiskasvatus 85 tuntia / kuukausi', 'Voucher value Daycare - 85 h per month', 'DAYCARE', FALSE, 0.5, 1.0, 1.75, 1.0, 1.75, 40, NULL, 85, TRUE, TRUE, 'Varhaiskasvatus 85 tuntia / kuukausi', 'Varhaiskasvatus 85 tuntia / kuukausi', 'Varhaiskasvatus 85 tuntia / kuukausi', 'Varhaiskasvatus 85 tuntia / kuukausi', '2023-08-01', TRUE, 4),
    ...
    ('f5d32585-2c78-4434-95d6-30b446db7d4d', 'Palveluseteli Varhaiskasvatus yli 140 tuntia / kuukausi', 'Palveluseteli Varhaiskasvatus yli 140 tuntia / kuukausi', 'Voucher value Daycare - over 140 h per month', 'DAYCARE', FALSE, 1.0, 1.0, 1.75, 1.0, 1.75, 40, NULL, 210, FALSE, FALSE, 'Varhaiskasvatus yli 140 tuntia / kuukausi', 'Varhaiskasvatus yli 140 tuntia / kuukausi', 'Varhaiskasvatus yli 140 tuntia / kuukausi', 'Varhaiskasvatus yli 140 tuntia / kuukausi', '2023-08-01', TRUE, 6),
    ('1b1e6e91-8d54-405c-88f8-2a95d88f8962', 'Palveluseteli pph Varhaiskasvatus 85 tuntia / kuukausi', 'Palveluseteli pph Varhaiskasvatus 85 tuntia / kuukausi', 'Voucher value cm Daycare - 85 h per month', 'DAYCARE', FALSE, 0.5, 1.0, 1.75, 1.0, 1.75, 40, NULL, 85, TRUE, TRUE, 'Varhaiskasvatus 85 tuntia / kuukausi', 'Varhaiskasvatus 85 tuntia / kuukausi', 'Varhaiskasvatus 85 tuntia / kuukausi', 'Varhaiskasvatus 85 tuntia / kuukausi', '2023-08-01', TRUE, 7),
    ('4d6d632d-d8cf-4b5a-8437-decade30d0c0', 'Palveluseteli pph Varhaiskasvatus yli 151 tuntia / kuukausi', 'Palveluseteli pph Varhaiskasvatus yli 151 tuntia / kuukausi', 'Voucher value cm Daycare - over 151 h per month', 'DAYCARE', FALSE, 1.0, 1.0, 1.75, 1.0, 1.75, 40, NULL, 210, FALSE, FALSE, 'Varhaiskasvatus yli 151 tuntia / kuukausi', 'Varhaiskasvatus yli 151 tuntia / kuukausi', 'Varhaiskasvatus yli 151 tuntia / kuukausi', 'Varhaiskasvatus yli 151 tuntia / kuukausi', '2023-08-01', TRUE, 8),
...
VALUES
    -- 2023-08-01 -
    ('03ae36de-7058-45a1-ba72-514afca39dcd', 'f9e7d841-49bf-43e5-8c65-028dad590a76', daterange('2023-08-01', NULL, '[]'), 90100, 0.60, 54060, 140600, 0.60, 84330),
    ...
    ('2c62904b-f187-4909-a21b-ffb399a350dd', '21a0589d-d4db-4978-9a37-8e6993a7dafd', daterange('2023-08-01', NULL, '[]'), 90100, 0.50, 45050, 140600, 0.50, 70300),
    ('dc39549c-f24f-4ca8-b5a3-da41174b3c06', '1c5d7ea4-669f-4b4e-8593-353be4c9cea0', daterange('2023-08-01', NULL, '[]'), 90100, 0.50, 45050, 140600, 0.50, 70300),
    ('be4e0582-585b-48a3-b7a5-237e6bd3db08', '9e6a4660-2f83-40e3-bf27-d9590e93dbf2', daterange('2023-08-01', NULL, '[]'), 90100, 0.50, 45050, 140600, 0.50, 70300),
    ('58732d96-6d0b-4c49-ae03-b916ef108497', '3b94630b-e01e-4b61-b040-8910baf96e97', daterange('2023-08-01', NULL, '[]'), 90100, 0.50, 45050, 140600, 0.50, 70300),
    ('80caa444-a957-4153-bb2b-2c18f01f17be', '593d8cbf-fcf8-41a7-a5fa-8fe96a7b93d8', daterange('2023-08-01', NULL, '[]'), 90100, 0.50, 45050, 140600, 0.50, 70300),
    ('42d94a69-ea81-403a-a03e-99a1e6343437', 'c169bce7-6533-4409-8acd-445061f1ff34', daterange('2023-08-01', NULL, '[]'), 90100, 0.50, 45050, 140600, 0.50, 70300),
    ...
    ('ada0df70-7441-4bf0-9b0b-f176d62985c0', '9cdef927-f31a-45cb-af49-3ea5b1c1cb8a', daterange('2023-08-01', NULL, '[]'), 90100, 0.50, 45050, 140600, 0.50, 70300),
    ('fb811658-6d0a-4552-bb07-7ea53cfa690f', '0a58d934-6fd1-11ed-a75e-c353faef5858', daterange('2023-08-01', NULL, '[]'), 90100, 0.50, 45050, 140600, 0.50, 70300),
    ('cd8f8c24-db93-4643-9ccd-655e7148b019', '0a58db0a-6fd1-11ed-a75e-bbde95c1aded', daterange('2023-08-01', NULL, '[]'), 90100, 0.50, 45050, 140600, 0.50, 70300),
    ('d8326cbd-a910-4c8e-95cf-446da5838df0', '0a58dbe6-6fd1-11ed-a75e-5335f2b9a91c', daterange('2023-08-01', NULL, '[]'), 90100, 0.50, 45050, 140600, 0.50, 70300),
    ('e9350573-8030-47ca-9b76-0e1483665aeb', '0a58da38-6fd1-11ed-a75e-9b2790b0b4f5', daterange('2023-08-01', NULL, '[]'), 90100, 0.50, 45050, 140600, 0.50, 70300),
    ('89f68398-68ae-4890-8fc5-e895a62135f7', '0a58dcae-6fd1-11ed-a75e-b3e10433b949', daterange('2023-08-01', NULL, '[]'), 90100, 0.50, 45050, 140600, 0.50, 70300),
