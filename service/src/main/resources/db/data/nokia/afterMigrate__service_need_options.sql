...
VALUES
    ...
    ('b3102992-df96-45d5-a1c3-578791c2193c', 'Esiopetusta täydentävä 86-139h/kk (palveluseteli)', 'Esiopetusta täydentävä 86-139h/kk (palveluseteli)', 'Preschool daycare - 86-139 h per month (voucher value)', 'PRESCHOOL_DAYCARE_ONLY', FALSE, 0.8, 1.0, 1.0, 1.0, 1.0, 40, NULL, 139, FALSE, FALSE, 'Esiopetusta täydentävä 86-139h/kk', 'Esiopetusta täydentävä 86-139h/kk', 'Esiopetusta täydentävä 86-139h/kk', 'Esiopetusta täydentävä 86-139h/kk', '2023-08-01', '2024-07-31', TRUE, 10)
ON CONFLICT (id) DO
    UPDATE SET
