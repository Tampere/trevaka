...
VALUES
    ...
    ('36c8c2ed-7543-47de-bc42-14d163a6277d', 'Palveluseteli 85 tuntia / kuukausi', 'Palveluseteli 85 tuntia / kuukausi', 'Voucher value - 85 h per month', 'DAYCARE', FALSE, 0.5, 1.0, 1.75, 1.0, 1.75, 40, NULL, 85, TRUE, TRUE, 'Varhaiskasvatus 85 tuntia / kuukausi', 'Varhaiskasvatus 85 tuntia / kuukausi', 'Varhaiskasvatus 85 tuntia / kuukausi', 'Varhaiskasvatus 85 tuntia / kuukausi', TRUE, TRUE, 4),
    ...
    ('f5d32585-2c78-4434-95d6-30b446db7d4d', 'Palveluseteli yli 140 tuntia / kuukausi', 'Palveluseteli yli 140 tuntia / kuukausi', 'Voucher value - over 140 h per month', 'DAYCARE', FALSE, 1.0, 1.0, 1.75, 1.0, 1.75, 40, NULL, 210, FALSE, FALSE, 'Varhaiskasvatus yli 140 tuntia / kuukausi', 'Varhaiskasvatus yli 140 tuntia / kuukausi', 'Varhaiskasvatus yli 140 tuntia / kuukausi', 'Varhaiskasvatus yli 140 tuntia / kuukausi', TRUE, TRUE, 6),
    ...
    ('93a50270-3f75-4672-b17d-db721bcb8ed2', 'Esiopetusta täydentävä 0-85h/kk (palveluseteli)', 'Esiopetusta täydentävä 0-85h/kk (palveluseteli)', 'Preschool daycare - 0-85 h per month (voucher value)', 'PRESCHOOL_DAYCARE', FALSE, 0.5, 1.0, 1.0, 1.0, 1.0, 40, NULL, 85, FALSE, FALSE, 'Esiopetusta täydentävä 0-85h/kk', 'Esiopetusta täydentävä 0-85h/kk', 'Esiopetusta täydentävä 0-85h/kk', 'Esiopetusta täydentävä 0-85h/kk', TRUE, TRUE, 9),
    ...
    ('fe0972a5-6ce9-41cc-a635-82fb22e7891b', 'Esiopetusta täydentävä 0-85h/kk (palveluseteli)', 'Esiopetusta täydentävä 0-85h/kk (palveluseteli)', 'Preschool daycare - 0-85 h per month (voucher value)', 'PRESCHOOL_DAYCARE_ONLY', FALSE, 0.5, 1.0, 1.0, 1.0, 1.0, 40, NULL, 85, FALSE, FALSE, 'Esiopetusta täydentävä 0-85h/kk', 'Esiopetusta täydentävä 0-85h/kk', 'Esiopetusta täydentävä 0-85h/kk', 'Esiopetusta täydentävä 0-85h/kk', TRUE, TRUE, 9),
