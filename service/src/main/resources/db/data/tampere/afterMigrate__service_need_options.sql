...
VALUES
    ...
    ('9cc7713c-f153-489a-a7c2-e001640f5c29', 'Täydentävä varhaiskasvatus, max 5h päivässä', 'Täydentävä varhaiskasvatus, max 5h päivässä', 'Preschool daycare - max 5 h per day', 'PRESCHOOL_DAYCARE_ONLY', TRUE, 0.6, 0.5, 0.5, 0.5, 0.5, 25, NULL, TRUE, FALSE, 'Täydentävä varhaiskasvatus, max 5h päivässä', 'Täydentävä varhaiskasvatus, max 5h päivässä', 'Täydentävä varhaiskasvatus, max 5h päivässä', 'Täydentävä varhaiskasvatus, max 5h päivässä', TRUE, FALSE, null),
    ('816d36b5-29b3-494b-8ac4-b2298764c803', 'Täydentävä varhaiskasvatus, max 5h päivässä', 'Täydentävä varhaiskasvatus, max 5h päivässä', 'Preschool daycare - max 5 h per day', 'PRESCHOOL_DAYCARE_ONLY', FALSE, 0.6, 0.5, 0.5, 0.5, 0.5, 25, NULL, TRUE, FALSE, 'Täydentävä varhaiskasvatus, max 5h päivässä', 'Täydentävä varhaiskasvatus, max 5h päivässä', 'Täydentävä varhaiskasvatus, max 5h päivässä', 'Täydentävä varhaiskasvatus, max 5h päivässä', TRUE, FALSE, 2000),
    ('9a2b393b-ebb6-49d9-aa1e-b86d80ba9eb5', 'Täydentävä varhaiskasvatus, max 5h päivässä; 10 pv sopimus', 'Täydentävä varhaiskasvatus, max 5h päivässä; 10 pv sopimus', 'Preschool daycare – max 5 h per day; 10 day agreement', 'PRESCHOOL_DAYCARE_ONLY', FALSE, 0.3, 0.25, 0.25, 0.5, 0.5, 12, 10, TRUE, TRUE, 'Täydentävä varhaiskasvatus, max 5h päivässä; 10 pv sopimus', 'Täydentävä varhaiskasvatus, max 5h päivässä; 10 pv sopimus', 'Täydentävä varhaiskasvatus, max 5h päivässä; 10 pv sopimus', 'Täydentävä varhaiskasvatus, max 5h päivässä; 10 pv sopimus', TRUE, FALSE, 2100),
    ('efcfd8f4-92d9-43a4-91e0-a7e2fde9c4e5', 'Täydentävä varhaiskasvatus, max 5h päivässä; 15 pv sopimus', 'Täydentävä varhaiskasvatus, max 5h päivässä; 15 pv sopimus', 'Preschool daycare – max 5 h per day; 15 day agreement', 'PRESCHOOL_DAYCARE_ONLY', FALSE, 0.45, 0.5, 0.5, 0.5, 0.5, 18, 15, TRUE, TRUE, 'Täydentävä varhaiskasvatus, max 5h päivässä; 15 pv sopimus', 'Täydentävä varhaiskasvatus, max 5h päivässä; 15 pv sopimus', 'Täydentävä varhaiskasvatus, max 5h päivässä; 15 pv sopimus', 'Täydentävä varhaiskasvatus, max 5h päivässä; 15 pv sopimus', TRUE, FALSE, 2200),
    ('313744dc-ac9e-46b1-8004-940d429664e3', 'Täydentävä varhaiskasvatus, yli 5h päivässä', 'Täydentävä varhaiskasvatus, yli 5h päivässä', 'Preschool daycare – over 5 h per day', 'PRESCHOOL_DAYCARE_ONLY', FALSE, 0.8, 0.5, 0.5, 0.5, 0.5, 32, NULL, FALSE, FALSE, 'Täydentävä varhaiskasvatus, yli 5h päivässä', 'Täydentävä varhaiskasvatus, yli 5h päivässä', 'Täydentävä varhaiskasvatus, yli 5h päivässä', 'Täydentävä varhaiskasvatus, yli 5h päivässä', TRUE, FALSE, 2300),
    ('9e1e61da-3362-4f8f-bbf9-ea1eb0d0206c', 'Täydentävä varhaiskasvatus, yli 5h päivässä; 10 pv sopimus', 'Täydentävä varhaiskasvatus, yli 5h päivässä; 10 pv sopimus', 'Preschool daycare – over 5 h per day; 10 day agreement', 'PRESCHOOL_DAYCARE_ONLY', FALSE, 0.4, 0.25, 0.25, 0.5, 0.5, 18, 10, FALSE, TRUE, 'Täydentävä varhaiskasvatus, yli 5h päivässä; 10 pv sopimus', 'Täydentävä varhaiskasvatus, yli 5h päivässä; 10 pv sopimus', 'Täydentävä varhaiskasvatus, yli 5h päivässä; 10 pv sopimus', 'Täydentävä varhaiskasvatus, yli 5h päivässä; 10 pv sopimus', TRUE, FALSE, 2400),
    ('b5269ff0-a047-496f-9bda-6286520ef1a5', 'Täydentävä varhaiskasvatus, yli 5h päivässä; 15 pv sopimus', 'Täydentävä varhaiskasvatus, yli 5h päivässä; 15 pv sopimus', 'Preschool daycare – over 5 h per day; 15 day agreement', 'PRESCHOOL_DAYCARE_ONLY', FALSE, 0.6, 0.5, 0.5, 0.5, 0.5, 24, 15, FALSE, TRUE, 'Täydentävä varhaiskasvatus, yli 5h päivässä; 15 pv sopimus', 'Täydentävä varhaiskasvatus, yli 5h päivässä; 15 pv sopimus', 'Täydentävä varhaiskasvatus, yli 5h päivässä; 15 pv sopimus', 'Täydentävä varhaiskasvatus, yli 5h päivässä; 15 pv sopimus', TRUE, FALSE, 2500),
