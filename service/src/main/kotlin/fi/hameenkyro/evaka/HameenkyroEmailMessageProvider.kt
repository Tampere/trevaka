...
class HameenkyroEmailMessageProvider : IEmailMessageProvider {
    ...
    private val unsubscribeFi = "<p><small>Jos et halua enää saada tämänkaltaisia viestejä, voit muuttaa asetuksia eVakan Omat tiedot -sivulla</small></p>"
    private val unsubscribeEn = "<p><small>If you no longer want to receive messages like this, you can change your settings on eVaka's Personal information page</small></p>"
...
""",
    ...
    override fun assistanceNeedPreschoolDecisionNotification(language: Language) = assistanceNeedDecisionNotification(language)
...
""",
    ...
    override fun outdatedIncomeNotification(notificationType: IncomeNotificationType, language: Language) = when (notificationType) {
