...
package fi.hameenkyro.evaka.emailclient.config
...
class EmailConfiguration {
    ...
    @Bean
    fun emailMessageProvider(): IEmailMessageProvider = HameenkyroEmailMessageProvider()
}

class HameenkyroEmailMessageProvider : IEmailMessageProvider {
    ...
    private fun getDaycareApplicationReceivedEmailHtml(): String = """
            ...
            <p>Ilta- ja vuorohoitoa haettaessa, hakemuksen liitteeksi tulee toimittaa molempien samassa taloudessa asuvien huoltajien todistukset työnantajalta vuorotyöstä tai oppilaitoksesta iltaisin tapahtuvasta opiskelusta. Hakemusta käsitellään vuorohoidon hakemuksena vasta sen jälkeen, kun edellä mainitut todistukset on toimitettu. Tarvittavat liitteet voi lisätä suoraan sähköiselle hakemukselle tai toimittaa postitse osoitteeseen Hämeenkyrön kunta, Varhaiskasvatus ja esiopetus, Härkikuja 7, 39100 Hämeenkyrö.</p>
    ...
    private fun getDecisionEmailHtml(): String = """
            ...
            <p>Päätös on nähtävissä Hämeenkyrön varhaiskasvatuksen verkkopalvelu eVakassa Päätökset-välilehdeltä.</p>
...
$unsubscribeEn
    ...
    override fun decisionNotification(): EmailContent = EmailContent.fromHtml(
        ...
        html =
        """
<p>Sinulle on saapunut uusi päätös Hämeenkyrön varhaiskasvatuksen verkkopalveluun eVakaan.</p>
$unsubscribeFi
<hr>
<p>You have received a new decision in Hämeenkyrö`s early childhood education system eVaka.</p>
$unsubscribeEn
            """
            .trimIndent(),
    )
    ...
    override fun financeDecisionNotification(
        ...
        return EmailContent.fromHtml(
            ...
            html =
            """
<p>Sinulle on saapunut uusi $decisionTypeFi Hämeenkyrön varhaiskasvatuksen verkkopalveluun eVakaan.</p>
$unsubscribeFi
<hr>
<p>You have received a new $decisionTypeEn in Hämeenkyrö's early childhood education system eVaka.</p>
$unsubscribeEn
            """
                .trimIndent(),
        )
