...
package fi.ylojarvi.evaka.message.config
...
internal const val PREFIX: String = "fi.ylojarvi.evaka.MessageProvider"
...
class MessageConfiguration {
    ...
    fun messageProvider(): IMessageProvider {
        val messageSource = YamlMessageSource(ClassPathResource("messages-ylojarvi.yaml"))
        return YlojarviMessageProvider(messageSource)
    }
}

internal class YlojarviMessageProvider(private val messageSource: MessageSource) : IMessageProvider {
