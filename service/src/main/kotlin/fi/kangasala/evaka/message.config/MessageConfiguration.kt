...
package fi.kangasala.evaka.message.config
...
internal const val PREFIX: String = "fi.kangasala.evaka.MessageProvider"
...
class MessageConfiguration {
    ...
    fun messageProvider(): IMessageProvider {
        val messageSource = YamlMessageSource(ClassPathResource("messages-kangasala.yaml"))
        return KangasalaMessageProvider(messageSource)
    }
}

internal class KangasalaMessageProvider(private val messageSource: MessageSource) : IMessageProvider {
