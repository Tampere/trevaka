...
package fi.kangasala.evaka.emailclient.config
...
class EmailConfiguration {
    ...
    @Bean
    fun emailMessageProvider(): IEmailMessageProvider = KangasalaEmailMessageProvider()
}

class KangasalaEmailMessageProvider : IEmailMessageProvider {
    ...
    private fun getPendingDecisionEmailHtml(): String = """
            <p>Olet saanut päätöksen/ilmoituksen Kangasalan varhaiskasvatukselta, joka odottaa toimenpiteitäsi. Myönnetty varhaiskasvatus-/kerhopaikka tulee hyväksyä tai hylätä kahden viikon sisällä päätöksen saapumisesta.</p>
            
            <p>Hakemuksen tekijä voi hyväksyä tai hylätä varhaiskasvatus-/kerhopaikan kirjautumalla Kangasalan varhaiskasvatuksen verkkopalveluun eVakaan tai ottamalla yhteyttä päätöksellä mainittuun päiväkodin johtajaan.</p>
    ...
    private fun getClubApplicationReceivedEmailHtml(): String = """
            ...
            <p>Hakemuksen tehnyt huoltaja voi muokata hakemusta Kangasalan varhaiskasvatuksen verkkopalvelussa eVakassa siihen saakka, kunnes se on otettu käsittelyyn asiakaspalvelussa.</p>
    ...
    private fun getDaycareApplicationReceivedEmailHtml(): String = """
            ...
            <p>Varhaiskasvatushakemuksella on neljän (4) kuukauden hakuaika. Hakemuksen tehnyt huoltaja voi muokata hakemusta Kangasalan varhaiskasvatuksen verkkopalvelussa eVakassa siihen saakka, kunnes se on otettu käsittelyyn.</p>
            ...
            <p>Ilta- ja vuorohoitoa haettaessa, hakemuksen liitteeksi tulee toimittaa molempien samassa taloudessa asuvien huoltajien todistukset työnantajalta vuorotyöstä tai oppilaitoksesta iltaisin tapahtuvasta opiskelusta. Hakemusta käsitellään vuorohoidon hakemuksena vasta sen jälkeen, kun edellä mainitut todistukset on toimitettu. Tarvittavat liitteet voi lisätä suoraan sähköiselle hakemukselle tai toimittaa postitse osoitteeseen Kangasalan kaupunki, Sivistyskeskus, Varhaiskasvatus - ja esiopetuspalvelut, PL 50, 36201 Kangasala.</p>
    ...
    private fun getPreschoolApplicationReceivedEmailHtml(): String = """
            ...
            <p>Hakemuksen tehnyt huoltaja voi muokata hakemusta Kangasalan varhaiskasvatuksen verkkopalvelussa eVakassa siihen saakka, kunnes se on otettu käsittelyyn.</p>
    ...
    private fun getDecisionEmailHtml(): String = """
            ...
            <p>Päätös on nähtävissä Kangasalan varhaiskasvatuksen verkkopalvelu eVakassa Päätökset-välilehdeltä.</p>
...
""",
    ...
    private fun outdatedIncomeNotificationInitial() = EmailContent.fromHtml(
        ...
        html = """
            ...
            <p>Lisätietoja saatte tarvittaessa Kangasalan kaupungin verkkosivuilta.</p>
            ...
            <p>If necessary, you can get more information from the website of the city of Kangasala.</p>
...
$unsubscribeEn
    ...
    override fun financeDecisionNotification(
        ...
        return EmailContent.fromHtml(
            ...
            html =
            """
<p>Sinulle on saapunut uusi $decisionTypeFi Kangasalan varhaiskasvatuksen verkkopalveluun eVakaan.</p>
$unsubscribeFi
<hr>
<p>You have received a new $decisionTypeEn in Kangasala's early childhood education system eVaka.</p>
$unsubscribeEn
            """
                .trimIndent(),
        )
