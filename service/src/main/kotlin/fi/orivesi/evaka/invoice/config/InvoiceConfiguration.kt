...
package fi.orivesi.evaka.invoice.config
...
import fi.orivesi.evaka.invoice.service.S3Sender
...
class InvoiceConfiguration {
    ...
    @Bean
    fun incomeTypesProvider(): IncomeTypesProvider = OrivesiIncomeTypesProvider()

    @Bean
    fun incomeCoefficientMultiplierProvider(): IncomeCoefficientMultiplierProvider = OrivesiIncomeCoefficientMultiplierProvider()

    @Bean
    fun invoiceProductProvider(): InvoiceProductProvider = OrivesiInvoiceProductProvider()
