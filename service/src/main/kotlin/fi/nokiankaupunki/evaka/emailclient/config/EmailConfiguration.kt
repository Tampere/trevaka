...
$unsubscribeEn
    ...
    override fun financeDecisionNotification(
        ...
        return EmailContent.fromHtml(
            ...
            html =
            """
<p>Sinulle on saapunut uusi $decisionTypeFi Nokian varhaiskasvatuksen verkkopalveluun eVakaan.</p>
$unsubscribeFi
<hr>
<p>You have received a new $decisionTypeEn in Nokia`s early childhood education system eVaka.</p>
$unsubscribeEn
            """
                .trimIndent(),
        )
