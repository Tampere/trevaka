...
class NokiaEmailMessageProvider : IEmailMessageProvider {
    ...
    private fun getDaycareApplicationReceivedEmailHtml(): String = """
            ...
            <p>Ilta- ja vuorohoitoa haettaessa, hakemuksen liitteeksi tulee toimittaa molempien samassa taloudessa asuvien huoltajien todistukset työnantajalta vuorotyöstä tai oppilaitoksesta iltaisin tapahtuvasta opiskelusta. Hakemusta käsitellään vuorohoidon hakemuksena vasta sen jälkeen, kun edellä mainitut todistukset on toimitettu. Tarvittavat liitteet voi lisätä suoraan sähköiselle hakemukselle tai toimittaa postitse osoitteeseen Nokian kaupunki, Sivistyspalvelut, varhaiskasvatuksen asiakaslaskutus, Harjukatu 23, 37100 Nokia.</p>
...
$unsubscribeEn
    ...
    override fun decisionNotification(): EmailContent = EmailContent.fromHtml(
        ...
        html =
        """
<p>Sinulle on saapunut uusi päätös Nokian varhaiskasvatuksen verkkopalveluun eVakaan.</p>
$unsubscribeFi
<hr>
<p>You have received a new decision in Nokia`s early childhood education system eVaka.</p>
$unsubscribeEn
            """
            .trimIndent(),
    )
    ...
    override fun financeDecisionNotification(
        ...
        return EmailContent.fromHtml(
            ...
            html =
            """
<p>Sinulle on saapunut uusi $decisionTypeFi Nokian kaupungin varhaiskasvatuksen verkkopalveluun eVakaan.</p>
$unsubscribeFi
<hr>
<p>You have received a new $decisionTypeEn in eVaka, the early childhood education system of the city of Nokia.</p>
$unsubscribeEn
            """
                .trimIndent(),
        )
