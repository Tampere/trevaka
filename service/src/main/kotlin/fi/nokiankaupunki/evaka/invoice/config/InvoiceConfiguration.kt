...
package fi.nokiankaupunki.evaka.invoice.config
...
class InvoiceConfiguration {
    ...
    fun invoiceIntegrationClient(
        ...
        return NokiaInvoiceIntegrationClient(s3Sender, invoiceGenerator)
    }

    @Bean
    fun incomeTypesProvider(): IncomeTypesProvider = NokiaIncomeTypesProvider()

    @Bean
    fun incomeCoefficientMultiplierProvider(): IncomeCoefficientMultiplierProvider = NokiaIncomeCoefficientMultiplierProvider()

    @Bean
    fun invoiceProductProvider(): InvoiceProductProvider = NokiaInvoiceProductProvider()
...
class NokiaIncomeTypesProvider : IncomeTypesProvider {
...
class NokiaIncomeCoefficientMultiplierProvider : IncomeCoefficientMultiplierProvider {
...
class NokiaInvoiceProductProvider : InvoiceProductProvider {
