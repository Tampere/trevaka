...
package fi.nokiankaupunki.evaka.message.config
...
internal const val PREFIX: String = "fi.nokiankaupunki.evaka.MessageProvider"
...
internal class NokiaMessageProvider(private val messageSource: MessageSource) : IMessageProvider {
    ...
    override fun getDefaultDecisionAddress(lang: OfficialLanguage): DecisionSendAddress = when (lang) {
        OfficialLanguage.FI, OfficialLanguage.SV -> DecisionSendAddress(
            ...
            row2 = "Varhaiskasvatuksen asiakaslaskustus",
            row3 = "",
        )
    }
