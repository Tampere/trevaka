...
package fi.pirkkala.evaka.message.config
...
internal const val PREFIX: String = "fi.pirkkala.evaka.MessageProvider"
...
internal class PirkkalaMessageProvider(private val messageSource: MessageSource) : IMessageProvider {
