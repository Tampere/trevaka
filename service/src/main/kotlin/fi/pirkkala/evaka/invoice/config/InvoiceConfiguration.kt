...
package fi.pirkkala.evaka.invoice.config
...
import fi.pirkkala.evaka.invoice.service.PirkkalaInvoiceIntegrationClient
import fi.pirkkala.evaka.invoice.service.ProEInvoiceGenerator
import fi.pirkkala.evaka.invoice.service.S3Sender
...
class InvoiceConfiguration {
    @Primary
    @Bean(name = ["pirkkalaInvoiceIntegrationClient"])
    fun invoiceIntegrationClient(
        ...
        return PirkkalaInvoiceIntegrationClient(clockService, s3Sender, invoiceGenerator)
    }

    @Bean
    fun incomeTypesProvider(): IncomeTypesProvider = PirkkalaIncomeTypesProvider()

    @Bean
    fun incomeCoefficientMultiplierProvider(): IncomeCoefficientMultiplierProvider = PirkkalaIncomeCoefficientMultiplierProvider()

    @Bean
    fun invoiceProductProvider(): InvoiceProductProvider = PirkkalaInvoiceProductProvider()
...
class PirkkalaIncomeCoefficientMultiplierProvider : IncomeCoefficientMultiplierProvider {
...
class PirkkalaInvoiceProductProvider : InvoiceProductProvider {
