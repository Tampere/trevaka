...
package fi.lempaala.evaka.emailclient.config
...
class EmailConfiguration {
    ...
    @Bean
    fun emailMessageProvider(): IEmailMessageProvider = LempaalaEmailMessageProvider()
}

class LempaalaEmailMessageProvider : IEmailMessageProvider {
    ...
    private fun getPendingDecisionEmailHtml(): String = """
            <p>Olet saanut päätöksen/ilmoituksen Lempäälän varhaiskasvatukselta, joka odottaa toimenpiteitäsi. Myönnetty varhaiskasvatus-/kerhopaikka tulee hyväksyä tai hylätä kahden viikon sisällä päätöksen saapumisesta.</p>
            
            <p>Hakemuksen tekijä voi hyväksyä tai hylätä varhaiskasvatus-/kerhopaikan kirjautumalla Lempäälän varhaiskasvatuksen verkkopalveluun eVakaan tai ottamalla yhteyttä päätöksellä mainittuun päiväkodin johtajaan.</p>
    ...
    private fun getClubApplicationReceivedEmailHtml(): String = """
            ...
            <p>Hakemuksen tehnyt huoltaja voi muokata hakemusta Lempäälän varhaiskasvatuksen verkkopalvelussa eVakassa siihen saakka, kunnes se on otettu käsittelyyn asiakaspalvelussa.</p>
    ...
    private fun getDaycareApplicationReceivedEmailHtml(): String = """
            ...
            <p>Varhaiskasvatushakemuksella on neljän (4) kuukauden hakuaika. Hakemuksen tehnyt huoltaja voi muokata hakemusta Lempäälän varhaiskasvatuksen verkkopalvelussa eVakassa siihen saakka, kunnes se on otettu käsittelyyn.</p>
            ...
            <p>Ilta- ja vuorohoitoa haettaessa, hakemuksen liitteeksi tulee toimittaa molempien samassa taloudessa asuvien huoltajien todistukset työnantajalta vuorotyöstä tai oppilaitoksesta iltaisin tapahtuvasta opiskelusta. Hakemusta käsitellään vuorohoidon hakemuksena vasta sen jälkeen, kun edellä mainitut todistukset on toimitettu. Tarvittavat liitteet voi lisätä suoraan sähköiselle hakemukselle tai toimittaa postitse osoitteeseen Lempäälän kunta, Varhaiskasvatuspalvelut, PL 36, 37501 Lempäälä.</p>
            ...
            <p>Lisätietoa hakemuksen käsittelystä ja varhaiskasvatuspaikan myöntämisestä saa varhaiskasvatuksen asiakaspalvelusta.</p>
    ...
    private fun getPreschoolApplicationReceivedEmailHtml(): String = """
            ...
            <p>Hakemuksen tehnyt huoltaja voi muokata hakemusta Lempäälän varhaiskasvatuksen verkkopalvelussa eVakassa siihen saakka, kunnes se on otettu käsittelyyn.</p>
    ...
    private fun getDecisionEmailHtml(): String = """
            ...
            <p>Päätös on nähtävissä Lempäälän varhaiskasvatuksen verkkopalvelu eVakassa Päätökset-välilehdeltä.</p>
...
""",
    ...
    private fun outdatedIncomeNotificationInitial() = EmailContent.fromHtml(
        ...
        html = """
            ...
            <p>Lisätietoja saatte tarvittaessa Lempäälän kunnan verkkosivuilta.</p>
            ...
            <p>If necessary, you can get more information from the website of the municipality of Lempäälä.</p>
...
$unsubscribeEn
    ...
    override fun decisionNotification(): EmailContent = EmailContent.fromHtml(
        ...
        html =
        """
<p>Sinulle on saapunut uusi päätös Lempäälän varhaiskasvatuksen verkkopalveluun eVakaan.</p>
$unsubscribeFi
<hr>
<p>You have received a new decision in Lempäälä`s early childhood education system eVaka.</p>
$unsubscribeEn
            """
            .trimIndent(),
    )
    ...
    override fun financeDecisionNotification(
        ...
        return EmailContent.fromHtml(
            ...
            html =
            """
<p>Sinulle on saapunut uusi $decisionTypeFi Lempäälän varhaiskasvatuksen verkkopalveluun eVakaan.</p>
$unsubscribeFi
<hr>
<p>You have received a new $decisionTypeEn in Lempäälä's early childhood education system eVaka.</p>
$unsubscribeEn
            """
                .trimIndent(),
        )
...
<hr>
    ...
    override fun absenceApplicationDecidedNotification(accepted: Boolean, startDate: LocalDate, endDate: LocalDate): EmailContent = EmailContent.fromHtml(
...
""",
    ...
    override fun passwordChanged(): EmailContent = EmailContent.fromHtml(
        subject =
        "eVaka-salasanasi on vaihdettu / Your eVaka password has been changed",
        html =
...
""",
    ...
    override fun emailChanged(newEmail: String): EmailContent = EmailContent.fromHtml(
        subject =
