...
package fi.lempaala.evaka.invoice.config
...
import fi.lempaala.evaka.invoice.service.S3Sender
...
class InvoiceConfiguration {
    ...
    @Bean
    fun incomeTypesProvider(): IncomeTypesProvider = LempaalaIncomeTypesProvider()

    @Bean
    fun incomeCoefficientMultiplierProvider(): IncomeCoefficientMultiplierProvider = LempaalaIncomeCoefficientMultiplierProvider()

    @Bean
    fun invoiceProductProvider(): InvoiceProductProvider = LempaalaInvoiceProductProvider()
