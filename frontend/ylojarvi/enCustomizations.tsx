...
const en: DeepPartial<Translations> = {
  applications: {
    creation: {
      ...
      transferApplicationInfo: {
        DAYCARE:
          'The child already has a place in early childhood education in Ylöjärvi. With this application you can apply for a transfer to another unit offering early childhood education in Ylöjärvi.',
        PRESCHOOL:
    ...
    editor: {
      ...
      unitPreference: {
        ...
        units: {
            ...
            PRESCHOOL: (
              <>
                ...
                <P>
                  Further information{' '}
                  <ExternalLink
                    href="https://ylojarvi.fi/palvelut/kasvatus-ja-opetus/esiopetus/"
                    text="https://ylojarvi.fi/palvelut/kasvatus-ja-opetus/esiopetus/"
                    newTab
                  />
                </P>
              </>
          ...
          serviceVoucherLink:
            'https://ylojarvi.fi/palvelut/kasvatus-ja-opetus/varhaiskasvatus/yksityiset-paivakodit/'
        }
      },
      heading: {
        info: {
      ...
      serviceNeed: {
        ...
        assistanceNeedInstructions: {
          DAYCARE:
            'Intensified or special care is given to a child as soon as the need arises. If a child has received an expert opinion backing the need for support, this must be notified in the early childhood education application. The support measures are carried out in the child’s daily life as part of the early childhood educational activities. Ylöjärvi’s early childhood education will separately be in contact after the application has been submitted, if the child has a need for support. The additional information given here will be visible to early childhood education service employees and special early childhood education teachers for the purposes of arranging an early childhood education placement.',
          CLUB: 'If the child has a need for support, the staff of Ylöjärvi’s early childhood education will get in contact the application has been submitted.',
          PRESCHOOL:
      ...
      additionalDetails: {
        dietInfo: (
          <>
            ...
            <ExternalLink
              href="https://ylojarvi.fi/palvelut/asuminen-ja-elinymparisto/siivous-ja-ruokapalvelu/erityisruokavaliot/"
  ...
  children: {
    ...
    vasu: {
      sharingLeopsDisclaimer:
        "When a child changes to another early childhood education unit in the City of Ylöjärvi, the early childhood education plan and other early childhood education documents are transferred to the new unit (also applies to early childhood education organized by Ylöjärvi as a purchasing service). The guardian will be informed about the transfer in advance. We ask the guardian for permission to hand over the early childhood education plan to an outsider. However, if a child enters private or other municipality's early childhood education, the early childhood education plan must be submitted to the new early childhood education provider even without permission, if the information is necessary for arranging the child's early childhood education (section 41 (3) of the Early Childhood Education Act). In addition, the early childhood education plan must be submitted to the organizer of pre-primary or primary education if it is necessary for the organization of the child's education (section 41 (4) of the Basic Education Act). The guardian will be informed of the transfer in advance."
    }
  },
  footer: {
    cityLabel: '© City of Ylöjärvi',
    privacyPolicyLink: (
      <ExternalLink
  ...
  loginPage: {
    ...
    title: `City of Ylöjärvi early childhood${
      preschoolEnabled ? ' and pre-primary' : ''
    } education`
  },
  map: {
    mainInfo: `In this view you can locate on the map all of Ylöjärvi’s early childhood education units and clubs. Regional service voucher units and clubs can also be found on the map.${
      preschoolEnabled
  ...
  accessibilityStatement: (
    <>
      ...
      <P>
        This accessibility statement applies to the City of Ylöjärvi’s early
        childhood education online service eVaka at{' '}
        <a href="https://evaka.ylojarvi.fi">evaka.ylojarvi.fi</a>. The City of
        Ylöjärvi endeavours to ensure the accessibility of the online service,
