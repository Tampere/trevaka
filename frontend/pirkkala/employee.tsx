...
import PirkkalaLogo from './PirkkalaLogo.svg'
...
const customizations: EmployeeCustomizations = {
  ...
  translations: {
      ...
      footer: {
        ...
        linkLabel: 'Pirkkalan varhaiskasvatus',
        linkHref: 'https://www.pirkkala.fi/kasvatus-ja-opetus/varhaiskasvatus/'
      },
      unit: {
        placementProposals: {
          rejectReasons: {
      ...
      unitEditor: {
        placeholder: {
          ...
          email: 'etunimi.sukunimi@pirkkala.fi',
          url: 'esim. https://www.pirkkala.fi/yhteystiedot/peiponpellon-paivakoti/',
      ...
      welcomePage: {
        text: 'Olet kirjautunut sisään eVaka Pirkkala -palveluun. Käyttäjätunnuksellesi ei ole vielä annettu oikeuksia, jotka mahdollistavat palvelun käytön. Tarvittavat käyttöoikeudet saat omalta esihenkilöltäsi.'
      },
      invoices: {
        buttons: {
