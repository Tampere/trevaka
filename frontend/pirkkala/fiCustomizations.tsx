...
import featureFlags from '../pirkkala/featureFlags'
...
const fi: DeepPartial<Translations> = {
  applications: {
    creation: {
      ...
      transferApplicationInfo: {
        DAYCARE:
          'Lapsella on jo paikka Pirkkalan varhaiskasvatuksessa. Tällä hakemuksella voit hakea siirtoa toiseen varhaiskasvatusta tarjoavaan yksikköön Pirkkalassa.',
        PRESCHOOL:
    ...
    editor: {
      ...
      serviceNeed: {
        ...
        assistanceNeedInstructions: {
          DAYCARE:
            'Tehostettua tai erityistä tukea annetaan lapselle heti tarpeen ilmettyä. Mikäli lapsella on olemassa tuen tarpeesta asiantuntijalausunto, tämä tulee ilmoittaa varhaiskasvatushakemuksella. Tukitoimet toteutuvat lapsen arjessa osana varhaiskasvatuksen toimintaa. Pirkkalan varhaiskasvatuksesta otetaan erikseen yhteyttä hakemuksen jättämisen jälkeen, jos lapsella on tuen tarve. Lisätiedot näkyvät varhaiskasvatuksen palveluohjauksessa ja varhaiskasvatuksen erityisopettajalle paikan järjestämiseksi.',
          CLUB: 'Jos lapsella on tuen tarve, Pirkkalan varhaiskasvatuksesta otetaan yhteyttä hakemuksen jättämisen jälkeen.',
          PRESCHOOL:
      ...
      contactInfo: {
        ...
        futureAddressInfo: `Pirkkalan varhaiskasvatuksessa ja esiopetuksessa virallisena osoitteena pidetään väestötiedoista saatavaa osoitetta. Osoite väestötiedoissa muuttuu hakijan tehdessä muuttoilmoituksen postiin tai maistraattiin.`
      },
      fee: {
        info: {
          DAYCARE: (
        ...
        links: (
          <P>
            ...
            <ExternalLink
              ...
              text="Pirkkalan kunnan sivuilta"
              newTab
            />
          </P>
        )
  ...
  loginPage: {
    ...
    title: `Pirkkalan kunnan varhaiskasvatus${
      preschoolEnabled ? ' ja esiopetus' : ''
    }`
  },
  map: {
    mainInfo: `Tässä näkymässä voit hakea kartalta kaikki Pirkkalan varhaiskasvatusyksiköt.${
      preschoolEnabled
  ...
  accessibilityStatement: (
    <>
      ...
      <P>
        Tämä saavutettavuusseloste koskee Pirkkalan kunnan varhaiskasvatuksen
        eVaka-verkkopalvelua osoitteessa{' '}
        <a href="https://evaka.pirkkala.fi">evaka.pirkkala.fi</a>. Pirkkalan
