...
const customizations: EmployeeCustomizations = {
  ...
  translations: {
      ...
      footer: {
        ...
        linkLabel: 'Vesilahden varhaiskasvatus',
        linkHref: 'https://www.vesilahti.fi/kasvatus-ja-opetus/varhaiskasvatus/'
      },
      unit: {
        placementProposals: {
          rejectReasons: {
      ...
      unitEditor: {
        placeholder: {
          ...
          email: 'etunimi.sukunimi@vesilahti.fi',
          url: 'esim. https://www.vesilahti.fi/yhteystiedot/peiponpellon-paivakoti/',
      ...
      welcomePage: {
        text: 'Olet kirjautunut sisään eVaka Vesilahti -palveluun. Käyttäjätunnuksellesi ei ole vielä annettu oikeuksia, jotka mahdollistavat palvelun käytön. Tarvittavat käyttöoikeudet saat omalta esihenkilöltäsi.'
      },
      invoices: {
        buttons: {
