...
import featureFlags from '../kangasala/featureFlags'
...
const fi: DeepPartial<Translations> = {
  applications: {
    creation: {
      ...
      transferApplicationInfo: {
        DAYCARE:
          'Lapsella on jo paikka Kangasalan varhaiskasvatuksessa. Tällä hakemuksella voit hakea siirtoa toiseen varhaiskasvatusta tarjoavaan yksikköön Kangasalla.',
        PRESCHOOL:
    ...
    editor: {
      ...
      serviceNeed: {
        ...
        assistanceNeedInstructions: {
          DAYCARE:
            'Tehostettua tai erityistä tukea annetaan lapselle heti tarpeen ilmettyä. Mikäli lapsella on olemassa tuen tarpeesta asiantuntijalausunto, tämä tulee ilmoittaa varhaiskasvatushakemuksella. Tukitoimet toteutuvat lapsen arjessa osana varhaiskasvatuksen toimintaa. Kangasalan varhaiskasvatuksesta otetaan erikseen yhteyttä hakemuksen jättämisen jälkeen, jos lapsella on tuen tarve. Lisätiedot näkyvät varhaiskasvatuksen palveluohjauksessa ja varhaiskasvatuksen erityisopettajalle paikan järjestämiseksi.',
          CLUB: 'Jos lapsella on tuen tarve, Kangasalan varhaiskasvatuksesta otetaan yhteyttä hakemuksen jättämisen jälkeen.',
          PRESCHOOL:
      ...
      contactInfo: {
        ...
        futureAddressInfo: `Kangasalan varhaiskasvatuksessa ja esiopetuksessa virallisena osoitteena pidetään väestötiedoista saatavaa osoitetta. Osoite väestötiedoissa muuttuu hakijan tehdessä muuttoilmoituksen postiin tai maistraattiin.`
      },
      fee: {
        info: {
          DAYCARE: (
  ...
  loginPage: {
    ...
    title: `Kangasalan kaupungin varhaiskasvatus${
      preschoolEnabled ? ' ja esiopetus' : ''
    }`
  },
  map: {
    mainInfo: `Tässä näkymässä voit hakea kartalta kaikki Kangasalan varhaiskasvatusyksiköt.${
      preschoolEnabled
  ...
  accessibilityStatement: (
    <>
      ...
      <P>
        Tämä saavutettavuusseloste koskee Kangasalan kaupungin
        varhaiskasvatuksen eVaka-verkkopalvelua osoitteessa{' '}
        <a href="https://evaka.kangasala.fi">evaka.kangasala.fi</a>. Kangasalan
