...
const customizations: EmployeeCustomizations = {
  ...
  translations: {
      ...
      welcomePage: {
        text: 'Olet kirjautunut sisään eVaka Hämeenkyrö -palveluun. Käyttäjätunnuksellesi ei ole vielä annettu oikeuksia, jotka mahdollistavat palvelun käytön. Tarvittavat käyttöoikeudet saat omalta esimieheltäsi.'
      },
      invoices: {
        buttons: {
