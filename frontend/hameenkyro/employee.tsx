...
const customizations: EmployeeCustomizations = {
  ...
  translations: {
      ...
      footer: {
        ...
        linkLabel: 'Hämeenkyrön varhaiskasvatus',
        linkHref:
          'https://www.hameenkyro.fi/kasvatus-ja-opetus/varhaiskasvatus/'
      },
      unit: {
        placementProposals: {
          rejectReasons: {
      ...
      unitEditor: {
        placeholder: {
          ...
          email: 'etunimi.sukunimi@hameenkyro.fi',
          url: 'esim. https://www.hameenkyro.fi/yhteystiedot/peiponpellon-paivakoti/',
      ...
      welcomePage: {
        text: 'Olet kirjautunut sisään eVaka Hämeenkyrö -palveluun. Käyttäjätunnuksellesi ei ole vielä annettu oikeuksia, jotka mahdollistavat palvelun käytön. Tarvittavat käyttöoikeudet saat omalta esihenkilöltäsi.'
      },
      invoices: {
        buttons: {
