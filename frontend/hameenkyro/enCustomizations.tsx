...
const en: DeepPartial<Translations> = {
    ...
    editor: {
      ...
      serviceNeed: {
        startDate: {
          ...
          info: {
            PRESCHOOL: [
              'The school year 2024-2025 starts on Thursday 8.8.2024 and ends on Friday 30.5.2025.'
            ]
          },
          label: {
  ...
  loginPage: {
    ...
    title: `Municipality of Hämeenkyrö early childhood${
      preschoolEnabled ? ' and pre-primary' : ''
    } education`
  },
  map: {
    mainInfo: `In this view you can locate on the map all of Hämeenkyrö’s early childhood education units and clubs. Regional service voucher units and clubs can also be found on the map.${
      preschoolEnabled
  ...
  accessibilityStatement: (
    <>
      ...
      <P>
        This accessibility statement applies to the Municipality of Hämeenkyrö’s
        early childhood education online service eVaka at{' '}
        <a href="https://evaka.hameenkyro.fi">evaka.hameenkyro.fi</a>. The
        Municipality of Hämeenkyrö endeavours to ensure the accessibility of the
      ...
      <P>
        ...
        the service, and this statement was drawn up on 16 February 2024.
      </P>
