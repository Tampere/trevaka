...
const customizations: EmployeeCustomizations = {
  ...
  translations: {
          ...
          appealInstructions: (
            <>
              ...
              <P>
                ...
                aikana. Tiedoksisaantipäivää tai sitä päivää, jona päätös on
                asetettu nähtäväksi, ei lueta määräaikaan. Jos määräajan
                viimeinen päivä on pyhäpäivä tai muu sellainen päivä, jona työt
                virastoissa on keskeytettävä, saa tehtävän toimittaa
              ...
              <ol>
                <li>
                  ...
                  puhelinnumero. Jos oikaisuvaatimuksen tekijän puhevaltaa
                  käyttää hänen laillinen edustajansa tai asiamiehensä, tai jos
          ...
          appealInstructions: (
            <>
              ...
              <P>
                ...
                oikaisuvaatimuksen. Päätökseen ei saa hakea muutosta
                valittamalla.
              </P>
              ...
              <P>
                ...
                virka-ajan päättymistä. Oikaisuvaatimuksen lähettäminen postitse
                tai sähköisesti tapahtuu lähettäjän omalla vastuulla.
              </P>
              ...
              <P>
                ...
                oikeuteen, velvollisuuteen tai etuun päätös välittömästi
                vaikuttaa (asianosainen) ja se, jonka valitusoikeudesta laissa
                erikseen säädetään. Viranomainen saa hakea muutosta valittamalla
                myös, jos valittaminen on tarpeen viranomaisen valvottavana
              ...
              <P>
                ...
                viimeistään valitusajan viimeisenä päivänä ennen
              ...
              <P>
                ...
                kuluttua sähköpostin lähettämisestä, saantitodistuksen
                osoittamana aikana tai tiedoksisaantitodistukseen merkittynä
                aikana. Päätöksen katsotaan tulleen viranomaisen tietoon
                kuitenkin kirjeen saapumispäivänä.
              </P>
              <P>
                Käytettäessä todisteellista sähköistä tiedoksiantoa päätös
                katsotaan annetun tiedoksi, kun asiakirja on noudettu
              ...
              <P>
                Valitus on tehtävä kirjallisesti. Myös sähköinen asiakirja
              ...
              <ol>
                ...
                <li>
                  mihin valitusoikeus perustuu, jos valituksen kohteena oleva
                  päätös ei kohdistu valittajaan.
                </li>
              </ol>
              <P>
                Valituksessa on lisäksi ilmoitettava valittajan nimi ja
                yhteystiedot. Jos puhevaltaa käyttää valittajan laillinen
                edustaja tai asiamies, myös tämän yhteystiedot on ilmoitettava.
                Yhteystietojen muutoksesta on valituksen vireillä ollessa
                ilmoitettava viipymättä hallintotuomioistuimelle. Valituksessa
                on ilmoitettava myös se postiosoite ja mahdollinen muu osoite,
                johon oikeudenkäyntiin liittyvät asiakirjat voidaan lähettää.
                Mikäli valittaja on ilmoittanut enemmän kuin yhden osoitteen,
                voi hallintotuomioistuin valita, mihin ilmoitetuista osoitteista
                se toimittaa oikeudenkäyntiin liittyvät asiakirjat.
              </P>

              <P noMargin>Valitukseen on liitettävä</P>
              <ol>
                <li>
                  selvitys siitä, milloin valittaja on saanut päätöksen
                  tiedoksi, tai muu selvitys valitusajan alkamisen ajankohdasta
                </li>
                <li>
              ...
              <P>
                Tuomioistuinmaksulain (1455/2015) 2 §:n nojalla
                muutoksenhakijalta peritään oikeudenkäyntimaksua
                hallinto-oikeudessa 270 euroa. Tuomioistuinmaksulaissa on
                erikseen säädetty tapauksista, joissa maksua ei peritä.
              </P>
            </>
          ),
          jurisdictionText:
      ...
      footer: {
        ...
        linkLabel: 'Nokian varhaiskasvatus',
        linkHref:
          'https://www.nokiankaupunki.fi/kasvatus-ja-opetus/varhaiskasvatus/'
      },
      unit: {
        placementProposals: {
          rejectReasons: {
      ...
      unitEditor: {
        placeholder: {
          ...
          email: 'etunimi.sukunimi@nokiankaupunki.fi',
          url: 'esim. https://www.nokiankaupunki.fi/yhteystiedot/peiponpellon-paivakoti/',
      ...
      welcomePage: {
        text: 'Olet kirjautunut sisään eVaka Nokia -palveluun. Käyttäjätunnuksellesi ei ole vielä annettu oikeuksia, jotka mahdollistavat palvelun käytön. Tarvittavat käyttöoikeudet saat omalta esihenkilöltäsi.'
      },
      invoices: {
        buttons: {
