...
const customizations: EmployeeCustomizations = {
  ...
  translations: {
      ...
      footer: {
        ...
        linkLabel: 'Lempäälän varhaiskasvatus',
        linkHref: 'https://www.lempaala.fi/kasvatus-ja-opetus/varhaiskasvatus/'
      },
      unit: {
        placementProposals: {
          rejectReasons: {
      ...
      unitEditor: {
        placeholder: {
          ...
          email: 'etunimi.sukunimi@lempaala.fi',
          url: 'esim. https://www.lempaala.fi/yhteystiedot/peiponpellon-paivakoti/',
      ...
      welcomePage: {
        text: 'Olet kirjautunut sisään eVaka Lempäälä -palveluun. Käyttäjätunnuksellesi ei ole vielä annettu oikeuksia, jotka mahdollistavat palvelun käytön. Tarvittavat käyttöoikeudet saat omalta esihenkilöltäsi.'
      },
      invoices: {
        buttons: {
